...
# AlphaEdit module is not present in this branch; commented out to keep
# the editor importable. Re-enable if `code/easyeditor/models/alphaedit/`
# is restored.
...
ALG_DICT = {
    ...
    # "AlphaEdit": apply_AlphaEdit_to_model,  # see import comment above
